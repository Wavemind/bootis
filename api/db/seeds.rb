...
space_near_bed = Characteristic.create!(value_type: 'less', label: 'Surface libre à côté du lit')
space_near_wc = Characteristic.create!(value_type: 'less', label: 'Distance libre minimum à côté des WCs')
space_front_of_wc = Characteristic.create!(value_type: 'less', label: 'Distance libre minimum devant des WCs')
wc_height = Characteristic.create!(value_type: 'less', label: 'Hauteur maximum lunette WC')
grab_bar = Characteristic.create!(value_type: 'equal', label: 'Besoin barre d’appui L WC')
folding_grab_bar = Characteristic.create!(value_type: 'equal', label: 'Besoin barre d’appui rabattable WC')
eurokey = Characteristic.create!(value_type: 'equal', label: 'Clé Eurokey')
sink_wc_space = Characteristic.create!(value_type: 'less', label: 'Distance Max entre Lavabo et WC')
shower = Characteristic.create!(value_type: 'equal', label: 'Y a t’il une douche')
bathtub = Characteristic.create!(value_type: 'equal', label: 'Y a t’il une baignore')
lift_seat = Characteristic.create!(value_type: 'equal', label: 'Besoin d’un siège élévateur de bain')
shower_grab_bar = Characteristic.create!(value_type: 'equal', label: 'Besoin barre d’appui L douche')
shower_folding_grab_bar = Characteristic.create!(value_type: 'equal', label: 'Besoin barre d’appui rabattable douche')
