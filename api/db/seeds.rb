...
shower = Characteristic.create!(value_type: 'equal', label: 'Y a t’il une douche', key: 'maxSlope')
bathtub = Characteristic.create!(value_type: 'equal', label: 'Y a t’il une baignore', key: 'maxSlope')
